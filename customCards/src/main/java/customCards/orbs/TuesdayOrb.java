...
public class TuesdayOrb extends CustomOrb {

    // Standard ID/Description
    public static final String ORB_ID = DefaultMod.makeID("TuesdayOrb");
    public static final String IMG = makeOrbPath("TuesdayOrb.png");
    ...
    private void applyStatus() {
        AbstractDungeon.actionManager.addToBottom(new ScryAction(4));
    }
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(img, cX - 65f, cY - 48.0f + bobEffect.y, 48.0f, 48.0f, 96.0f, 96.0f, scale + MathUtils.sin(angle / PI_4) * ORB_WAVY_DIST * Settings.scale, scale, angle, 0, 0, 96, 96, false, false);
        renderText(sb);
        hb.render(sb);
    }
