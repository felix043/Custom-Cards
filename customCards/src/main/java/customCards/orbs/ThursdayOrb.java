...
public class ThursdayOrb extends CustomOrb {

    // Standard ID/Description
    public static final String ORB_ID = DefaultMod.makeID("ThursdayOrb");
    public static final String IMG = makeOrbPath("ThursdayOrb.png");
    ...
    private void applyStatus() {
        actionManager.addToBottom(new GainEnergyAction(2));
    }
